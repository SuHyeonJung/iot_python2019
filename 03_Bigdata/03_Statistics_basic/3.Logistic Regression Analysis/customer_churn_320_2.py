...
print("Debug] churn.pivot_table(['total_charges'], index=['churn'],"
      "'custserv_calls']))")
print(churn.pivot_table(['total_charges'], index=['churn', 'custserv_calls']))
print("\n\nDebug] churn.pivot_table(['total_charges'], index=['churn'],"
      "columns=['custserv_calls']))")
print(churn.pivot_table(['total_charges'], index=['churn'],columns=['custserv_calls']))
print("\nDebug] churn.pivot_table(['total_charges'], index=['custserv_calls'],"

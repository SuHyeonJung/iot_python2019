...
columns_change = ['driveway01', 'recroom01', 'fullbase01', 'gashw01', 'airco01',
                  'prefarea01']
...
independent_variables_list = ['lotsize', 'bedrooms', 'bathroom', 'stories',
            'driveway01', 'recroom01', 'fullbase01', 'gashw01', 'airco01',
                        'garagepl', 'prefarea01']
...
for num in range(1, 12):
    ...
    for tup in combi_list:
        ...
        match_dic_5['%s' % my_formula.replace('price ~ ', '')] = match_dic_5/len(y_predicted) * 100
        match_dic_10['%s' % my_formula.replace('price ~ ', '')] = match_dic_10 / len(y_predicted) * 100
        match_dic_20['%s' % my_formula.replace('price ~ ', '')] = match_dic_20 / len(y_predicted) * 100
